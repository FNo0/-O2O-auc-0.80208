...
def get_L_User_Merchant_Feat(dataframe_L,dataframe):
    ...
    # 领取满减券次数 / 领券次数
    dataset[prefixs + 'Receive_Coupon_cnt_isManjian_div_Receive_cnt'] = dataset[prefixs + 'Receive_Coupon_cnt_isManjian'] / (dataset[prefixs + 'Receive_Coupon_cnt'] + 0.1)
    # 领取非满减次数 / 领券次数
    dataset[prefixs + 'Receive_Coupon_cnt_isNotManjian_div_Receive_cnt'] = dataset[prefixs + 'Receive_Coupon_cnt_isNotManjian'] / (dataset[prefixs + 'Receive_Coupon_cnt'] + 0.1)
